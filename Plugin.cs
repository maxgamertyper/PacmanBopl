...
namespace Pacman
{
    [BepInPlugin("com.maxgamertyper1.pacmanborder", "Pacman Border", "1.0.0")]
    ...
    public class Patches
    {
        ...
        {
            FixTransform fixTrans = (FixTransform)Traverse.Create(__instance).Field("fixTrans").GetValue();
    ...
    // not working: beam
    // fix the platforms that move out of bounce, i.e yellow things, asteroids
}